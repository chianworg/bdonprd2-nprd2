...
custom_replacements = {
  ...
  */
  names = {
    ...
    management_resource_group_name               = "rgbdo6-management-$${starter_location_01}"
    connectivity_hub_vwan_resource_group_name    = "rgbdo6-hub-vwan-$${starter_location_01}"
    connectivity_hub_primary_resource_group_name = "rgbdo6-hub1-$${starter_location_01}"
    ...
    dcr_change_tracking_name                = "bdo6dcr-change-tracking"
    dcr_defender_sql_name                   = "bdo6dcr-defender-sql"
    dcr_vm_insights_name                    = "bdo6dcr-vm-insights"
    ...
    # primary_bastion_host_name                          = "bdo6bas-hub-$${starter_location_01}"
    # primary_bastion_host_public_ip_name                = "bdo6pip-bastion-hub-$${starter_location_01}"

    # Resource names primary secondary
    # secondary_hub_name                                   = "bdo6vwan-hub2-$${starter_location_02}"
    # secondary_sidecar_virtual_network_name               = "bdo6vnet-sidecar2-$${starter_location_02}"
    # secondary_firewall_name                              = "bdo6fw-hub2-$${starter_location_02}"
    # secondary_firewall_policy_name                       = "bdo6fwp-hub2-$${starter_location_02}"
    # secondary_virtual_network_gateway_express_route_name = "bdo6vgw-hub2-er-$${starter_location_02}"
    # secondary_virtual_network_gateway_vpn_name           = "bdo6vgw-hub2-vpn-$${starter_location_02}"
    # secondary_private_dns_resolver_name                  = "bdo6pdr-hub2-dns-$${starter_location_02}"
...
tags = {
  ...
  source      = "bdo6 Azure Landing Zones Accelerator"
}
